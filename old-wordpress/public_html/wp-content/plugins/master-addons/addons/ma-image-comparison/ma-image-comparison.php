...
class Master_Addons_Image_Comparison extends Widget_Base {
    ...
    protected function _content_template() {
        ?>
        <#
            var visible_ratio       = ( settings.jltma_image_comparison_visible_ratio.size != '' ) ? settings.jltma_image_comparison_visible_ratio.size / 100 : '0.5';
            var slider_on_hover     = ( settings.jltma_image_comparison_move_handle == 'mouse_move' ) ? true : false;
            var slider_with_handle  = ( settings.jltma_image_comparison_move_handle == 'drag' ) ? true : false;
            var slider_with_click   = ( settings.jltma_image_comparison_move_handle == 'mouse_click' ) ? true : false;
            var no_overlay          = ( settings.jltma_image_comparison_overlay == 'yes' ) ? false : true;
        #>
