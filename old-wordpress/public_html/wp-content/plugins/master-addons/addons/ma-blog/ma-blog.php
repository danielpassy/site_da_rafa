	...
	class Master_Addons_Post_Grid extends Widget_Base {
		...
		protected function _register_controls() {
		    ...
		    */
            ...
            $this->add_control('ma_el_blog_thumb_border_radius',
                [
            ...
            $this->add_responsive_control('ma_el_blog_title_padding',
                [
            ...
            $this->add_responsive_control('ma_el_blog_title_margin',
                [
            ...
            $this->add_responsive_control('ma_el_blog_content_box_padding',
                [
			 ...
			 * Read More Settings
			 */
            $this->start_controls_section('ma_el_excerpt_read_more_style_section',
                [
            ...
            $this->add_control('ma_el_excerpt_read_more_color',
                [
                    'label'         => __('Text Color', MELA_TD ),
                    'type'          => Controls_Manager::COLOR,
                    'scheme'        => [
            ...
            $this->add_control('ma_el_excerpt_read_more_hover_color',
                [
            ...
            $this->add_control('ma_el_excerpt_read_more_bg_color',
                [
            ...
            $this->add_responsive_control('ma_el_excerpt_read_more_padding',
                [
            ...
            $this->add_responsive_control('ma_el_excerpt_read_more_margin',
                [
                    'label'         => __('Content Margin', MELA_TD),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => ['px', 'em', '%'],
