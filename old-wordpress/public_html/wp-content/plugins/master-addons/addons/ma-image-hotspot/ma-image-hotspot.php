 ...
 * News Ticker Widget
 */
class Master_Addons_Image_Hotspot extends Widget_Base {
...
//								}
                            ...
                            <div <?php echo $this->get_render_attribute_string( 'ma_el_tooltip_wrapper' ); ?>>
                                <div class="ma-el-tooltip-item tooltip-<?php echo
                                ($item['ma_el_hotspot_tooltip_position'])? $item['ma_el_hotspot_tooltip_position']:$settings['ma_el_hotspot_position'];?>">
...
Plugin::instance()->widgets_manager->register_widget_type( new Master_Addons_Image_Hotspot() );
