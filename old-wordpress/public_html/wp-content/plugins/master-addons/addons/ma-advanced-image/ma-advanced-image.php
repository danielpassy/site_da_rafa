<?php
	...
	class Master_Addons_Advanced_Image extends Widget_Base {
		...
		public function ma_el_get_the_resized_attachment_src( $attach_id = null, $width = null , $height = null,
			$crop = null , $quality = 100, $upscale = false ) {
	...
	Plugin::instance()->widgets_manager->register_widget_type( new Master_Addons_Advanced_Image() );
