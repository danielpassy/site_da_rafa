<?php
	 ...
	 */
	class Master_Addons_Table_Of_Contents extends Widget_Base {
...
//						'#ma-el-toc-{{ID}} .ma-el-offcanvas-bar' => 'background-color: {{VALUE}};',
		...
		public function ma_el_layout_offcanvas(){
			...
			$this->add_render_attribute( 'offcanvas', 'class',  [ 'ma-el-offcanvas', 'ma-el-ofc-table-of-content', 'ma-el-flex',
				'ma-el-flex-middle', 'ma-el-toc-content-' . $index_align ] );
			?>

			<div class="table-of-content-layout-offcanvas" >
				<div class="ma-el-toggle-button-wrapper ma-el-position-fixed ma-el-toc-position-<?php echo esc_attr
                ($settings['ma_el_toc_button_position']); ?>">
		...
		private function ma_el_layout_dropdown() {
            ...
            <div <?php echo $this->get_render_attribute_string( 'ma_el_dropdown_table_of_contents' ); ?>>
                ...
                esc_attr($settings['ma_el_toc_button_position']); ?>">
                    <a id="<?php echo $id; ?>" class="ma-el-toggle-button elementor-button elementor-size-sm"
                       href="#">
						<?php $this->ma_el_toc_render_toggle_button_content(); ?>
                    </a>
                </div>
...
//                                'scrollEndCallback'=> function (e) { },
            ...
            <div class="js-toc ma-el-table-of-content" <?php echo $this->get_render_attribute_string( 'ma_el_toc'
            ); ?>></div>
			<?php
		}

	}
	Plugin::instance()->widgets_manager->register_widget_type( new Master_Addons_Table_Of_Contents() );
