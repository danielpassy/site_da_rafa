<?php
	...
	class Master_Addons_News_Ticker extends Widget_Base {
		...
		protected function _register_controls() {
			...
			$this->add_control('ma_el_news_ticker_scroll',
				[
			...
			$this->add_control('ma_el_news_ticker_categories',
				[
			...
			$this->add_control('ma_el_news_ticker_tags',
				[
			...
			$this->add_control('ma_el_news_ticker_posts_orderby',
				[
...
//			);
			...
			$this->add_responsive_control('ma_el_news_ticker_label_border_radius',
				[
			...
			$this->add_responsive_control('ma_el_news_ticker_angle_margin',
				[
		...
		protected function render() {
			...
			$this->add_render_attribute('ma_el_news_ticker',
			'class', [
					'ma-el-news-ticker'
				]
			);
...
//			$border = 'yes' == $settings['ma_el_news_ticker_show_border'] ? true : false;
			...
			$this->add_render_attribute('ma_el_news_ticker', 'data-feedanimation',
                $ma_el_news_ticker_feed_animation_styles );
...
//			$this->add_render_attribute('ma_el_news_ticker', 'data-border', $border );
                            ...
                            <?php if( $ma_el_news_ticker_type == "content"){?>
                                ...
                                <ul class="ma-el-ticker-content-items">
                                    ...
                                    <?php
                                        ...
                                        $i = 0;
                                        foreach ( $breaking_news as $post ) { setup_postdata( $post ); $i++;?>
	...
	Plugin::instance()->widgets_manager->register_widget_type( new Master_Addons_News_Ticker() );
