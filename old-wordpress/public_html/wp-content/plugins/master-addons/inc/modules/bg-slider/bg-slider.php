...
class Master_Addons_Background_Slider {
            ...
            jQuery(document).ready(function () {
                ...
                if ('<?php echo $settings["ma_el_custom_overlay_switcher"]; ?>' == 'yes') {
                    jQuery(".elementor-element-<?php echo $element->get_id(); ?>").children('.ma-el-section-bs')
                        .children
                    ('.ma-el-section-bs-inner').children('.vegas-overlay').css('background-image', '');
                }
            });
        </script>
		<?php
	...
	function _print_template( $template, $widget ) {
        ...
        var ma_el_transition = settings.ma_el_slider_transition;
        var ma_el_animation = settings.ma_el_slider_animation;
        var ma_el_custom_overlay = settings.ma_el_custom_overlay_switcher;
        var ma_el_overlay = '';
        var ma_el_cover = settings.ma_el_slider_cover;
        var ma_el_delay = settings.ma_el_slider_delay;
        var ma_el_timer = settings.ma_el_slider_timer_bar;

        if(!_.isUndefined(settings.ma_el_bg_slider_images) && settings.ma_el_bg_slider_images.length){
        var slider_data = [];
        ...
        //if(settings.ma_el_slider_custom_overlay_image.url){
        //ma_el_overlay = settings.ma_el_slider_custom_overlay_image.url;
        //}else{
        ...
        <div class="ma-el-section-bs">
            <div class="ma-el-section-bs-inner"
                 data-ma-el-bg-slider="{{ slides_path_string }}"
                 data-ma-el-bg-slider-transition="{{ ma_el_transition }}"
                 data-ma-el-bg-slider-animation="{{ ma_el_animation }}"
                 data-ma-el-bg-custom-overlay="{{ ma_el_custom_overlay }}"
                 data-ma-el-bg-slider-overlay="{{ ma_el_overlay }}"
                 data-ma-el-bg-slider-cover="{{ ma_el_cover }}"
                 data-ma-el-bs-slider-delay="{{ ma_el_delay }}"
                 data-ma-el-bs-slider-timer="{{ ma_el_timer }}"
            ></div>
        </div>
...
Master_Addons_Background_Slider::instance();