...
class Master_Addons_Post_Page_Duplicator {
	...
	public function jltma_duplicate_post_as_draft(){
		 ...
		 */
		if( ! wp_verify_nonce( $_REQUEST['_wpnonce'], 'jltma_post_duplicator_nonce' ) ) { return; }
...
Master_Addons_Post_Page_Duplicator::get_instance();
