<?php
	namespace MasterAddons\Modules\PseudoElements;
	...
	class Master_Addons_Pseudo_Elements{
		...
		public function __construct() {
			...
			add_action( "elementor/element/after_section_end", array( $this, 'jltma_section_add_pseudo_elements_controls'),
				20,3 );
...
//			}
			...
			$widget->add_control('ma_el_pseudo_before_content',
				[
			...
			$widget->add_control('ma_el_pseudo_after_content',
				[
					'label'         => __( 'Content', MELA_TD ),
					'type'          => Controls_Manager::TEXT,
					'default'       => '',
	...
	Master_Addons_Pseudo_Elements::get_instance();
