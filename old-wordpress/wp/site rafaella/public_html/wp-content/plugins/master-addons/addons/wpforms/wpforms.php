<?php
	...
	class Master_Addons_WP_Forms extends Widget_Base {
				...
				if ( ! empty( $settings['contact_form_list'] ) ) { ?>
					<div <?php echo $this->get_render_attribute_string( 'contact-form' ); ?>>
						...
						<?php
							...
							echo wpforms_display( $settings['contact_form_list'], $ma_el_form_title,
	...
	Plugin::instance()->widgets_manager->register_widget_type( new Master_Addons_WP_Forms() );