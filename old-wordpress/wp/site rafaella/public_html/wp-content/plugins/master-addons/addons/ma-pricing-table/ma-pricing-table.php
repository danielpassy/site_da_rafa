<?php
	...
	class Master_Addons_Pricing_Table extends Widget_Base {
		...
		protected function _register_controls() {
			...
			$repeater->start_controls_tab( 'ma_el_pricing_table_features_list_tab_normal_text',
				[
			...
			$repeater->start_controls_tab( 'ma_el_pricing_table_features_list_tab_tooltip_text',
				[
...
//						'{{WRAPPER}} .ma-el-fraction-price' => 'justify-content: {{VALUE}}',
			...
			$this->start_controls_tab( 'ma_el_pricing_table_tab_features_tooltip_text',
				[
					'label' => __( 'Tooltip Text', MELA_TD )
				]
			);
		...
		public function jltma_pt_render_heading(){
			...
			if ( $settings['ma_el_pricing_table_heading'] || $settings['ma_el_pricing_table_sub_heading'] ){ ?>
				...
				<?php if ( ! empty($settings['ma_el_pricing_table_sub_heading']) ) { ?>
					<div class="ma-el-price-table-subheading"><?php echo esc_html
                        ($settings['ma_el_pricing_table_sub_heading']);
					?></div>
				<?php } ?>
		...
		public function jltma_pt_render_header(){
			...
			$this->add_render_attribute( 'ma_el_pricing_table_head', 'class', [
		...
		public function render_features_list() {
			...
			$this->add_render_attribute( 'ma_el_pricing_table_tooltip', [
					'class' => 'ma-el-tooltip'
				]
			);
			...
			if ( ! empty( $settings['ma_el_pricing_table_features_list'] ) ) {?>
				...
				<?php foreach ( $settings['ma_el_pricing_table_features_list'] as $item ) {
					...
					if ( $item['ma_el_pricing_table_tooltip_text'] ) {
                        ...
                        <li class="<?php if ( $item['ma_el_pricing_table_tooltip_text'] ) { echo "ma-el-tooltip"; }
		...
		protected function render() {
			...
			$this->add_render_attribute( 'ma_el_pricing_table', 'class', [
			        'me-el-pricing-tables',
					$ma_el_table_class
				]
			);

			$this->add_render_attribute( 'ma_el_pricing_table_container', 'class', [
			        'ma-el-price-table',
			...
			?>
                ...
                <section <?php echo $this->get_render_attribute_string( 'ma_el_pricing_table' );?>>
                    ...
                    <div <?php echo $this->get_render_attribute_string( 'ma_el_pricing_table_container' ); ?>>
	                    ...
	                    <?php if($ma_el_pricing_table_layout == 'three'||
