<?php
	...
	class Master_Addons_Cards extends Widget_Base {
		...
		public function get_title() {
			return esc_html__( 'MA Cards', MELA_TD );
		}
			...
			($settings['ma_el_card_preset']); ?>">
				...
				<div class="ma-el-card-body">
					<a href="<?php echo esc_url( $settings['ma_el_card_title_link']['url'] ); ?>"
					   class="ma-el-card-title"><?php echo $settings['ma_el_card_title']; ?></a>
					...
					<a href="<?php echo esc_url( $settings['ma_el_card_action_link']['url'] ); ?>"
					   class="ma-el-card-action">
